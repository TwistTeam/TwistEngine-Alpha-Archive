...
class Flx3DCamera extends game.objects.improvedFlixel.FlxCamera
{
	#if THREE_D_ALLOWED
	...
	public override function render()
	{
		...
		view.x = FlxG.game.x
			+ FlxG.game.scaleX * (flashSprite.x + flashSprite.scaleX * (_scrollRect.x + _scrollRect.scaleX * (_scrollRect.scrollRect.x)))
			- _scrollRect.scrollRect.width * ((zoom / initialZoom) - 1) / 2;
		view.y = FlxG.game.y
			+ FlxG.game.scaleY * (flashSprite.y + flashSprite.scaleY * (_scrollRect.y + _scrollRect.scaleY * (_scrollRect.scrollRect.y)))
			- _scrollRect.scrollRect.height * ((zoom / initialZoom) - 1) / 2;

		view.width = _scrollRect.scrollRect.width / initialZoom + _scrollRect.scrollRect.width / initialZoom * ((zoom / initialZoom) - 1);
		view.height = _scrollRect.scrollRect.height / initialZoom + _scrollRect.scrollRect.height / initialZoom * ((zoom / initialZoom) - 1);
