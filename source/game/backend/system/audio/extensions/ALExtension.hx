package game.backend.system.audio.extensions;
...
import game.backend.system.audio.extensions.NativeCFFIExt;

@:access(game.backend.system.audio.extensions.NativeCFFIExt)
class ALExtension {
