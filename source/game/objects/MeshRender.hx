...
class MeshRender extends FlxStrip
{
	 ...
	 * Add a vertex.
	 */
	public function build_vertex(x:Float, y:Float, u:Float = 0, v:Float = 0):Int
	{
	...
	*     c
	*/
	public function build_tri(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float,
	 ...
	 * bottom left - d
	 */
	public function build_quad(ax:Float, ay:Float, bx:Float, by:Float, cx:Float, cy:Float, dx:Float, dy:Float,
		au:Float = 0, av:Float = 0, bu:Float = 0, bv:Float = 0, cu:Float = 0, cv:Float = 0, du:Float = 0, dv:Float = 0):Void
	{
		// top right
