	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>){
		...
		switch (PlayState.SONG.song.toLowerCase()){
			...
			case 'thorns':
				...
				face.setGraphicSize(face.width * 6);
				add(face);
		}
		...
		portraitLeft.setGraphicSize(portraitLeft.width * PlayState.daPixelZoom * 0.9);
		...
		portraitRight.setGraphicSize(portraitRight.width * PlayState.daPixelZoom * 0.9);
		...
		box.setGraphicSize(box.width * PlayState.daPixelZoom * 0.9);
		box.updateHitbox();
		add(box);
		...
		handSelect.setGraphicSize(handSelect.width * PlayState.daPixelZoom * 0.9);
