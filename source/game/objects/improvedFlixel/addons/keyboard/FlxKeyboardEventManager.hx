...
import game.objects.improvedFlixel.addons.keyboard.FlxKeyboardEvent.KeyboardEventCallback;
...
class FlxKeyboardEventManager extends FlxBasic
{
	...
	{
		list.push(new FlxKeyboardEvent(keyList, onPressed, onJustPressed, onReleased, onJustReleased, pressAllKeys));
	}
