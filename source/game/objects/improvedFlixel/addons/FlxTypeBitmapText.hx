...
class FlxTypeBitmapText extends FlxBitmapText
{
	/**
	...
	/**
	 * This function is called when typing a message.
	 */
	public var typeCallback:Void->Void;
	...
	public override function update(elapsed:Float):Void
	{
		...
		if (text != helperString)
		{
			text = helperString;

			if (!_waiting && typeCallback != null)
			{
				typeCallback();
			}
