...
enum abstract ModifierOrder(Int32) to Int32
{
	var FIRST = -1000;
	var PRE_REVERSE = -3;
	var REVERSE = -2;
...
class Modifier
{
	...
	public function getOrder():Int32
		return DEFAULT;
	...
	public function getPos(time:Float, diff:Float, tDiff:Float, beat:Float, pos:Vector3, data:Int, player:Int, obj:INote)
		return pos;
