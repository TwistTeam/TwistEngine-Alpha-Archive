...
class FlxDestroyUtil
{
	 ...
	 * @return 	null
	 */
	public static function dispose(bitmapData:BitmapData, ?dontDisposeTexture:Bool = false):BitmapData
	{
		if (bitmapData != null)
		{
			if (!dontDisposeTexture)
			{
	 ...
	 */
	public static function disposeIfNotEqual(bitmapData:BitmapData, width:Float, height:Float, ?dontDisposeTexture:Bool = false):BitmapData
	{
