...
class CameraFrontEnd
{
	...
	/** @since 4.2.0 */
	public var cameraAdded(default, null):FlxTypedSignal<FlxCamera->Void> = new FlxTypedSignal();

	/** @since 4.2.0 */
	public var cameraRemoved(default, null):FlxTypedSignal<FlxCamera->Void> = new FlxTypedSignal();

	/** @since 4.2.0 */
	public var cameraResized(default, null):FlxTypedSignal<FlxCamera->Void> = new FlxTypedSignal();

	/** @since 4.2.0 */
	public var cameraReset(default, null):FlxTypedSignal<FlxCamera->Void> = new FlxTypedSignal();

	/** @since 4.2.0 */
	public var cameraResetPost(default, null):FlxTypedSignal<FlxCamera->Void> = new FlxTypedSignal();
