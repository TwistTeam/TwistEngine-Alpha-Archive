...
class FlxTypedGroup<T:FlxBasic> extends FlxBasic
{
	...
	static function resolveGroup(basic:FlxBasic):FlxTypedGroup<FlxBasic>
	{
		if (basic != null)
		{
			...
			{
				// cpp return ( ( ::flixel::group::FlxTypedGroup)(( ( ::flixel::group::FlxTypedSpriteGroup)(basic) )->__Field(HX_("group",3f,b3,f4,99),::hx::paccDynamic)) );
				// return cast (cast basic:FlxTypedSpriteGroup<Dynamic>).group;
				// cpp: return ( ( ::flixel::group::FlxTypedGroup)(basic->__Field(HX_("group",3f,b3,f4,99),::hx::paccDynamic)) );
				return (cast basic:Dynamic).group;
			}
		}
		return null;
	}
