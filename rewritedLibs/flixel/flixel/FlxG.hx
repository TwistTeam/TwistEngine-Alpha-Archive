...
class FlxG
{
	...
	public static var fixedDelta(default, null):Float = 0;
	...
	public static var sounds(get, never):SoundFrontEnd;
	static function get_sounds():SoundFrontEnd return sound;
	#end
