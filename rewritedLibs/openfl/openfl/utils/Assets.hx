...
class Assets
{
	public static var allowGPU:Bool = #if hl false #else true #end;
	...
	**/
	...
	public static function getBitmapData(id:String, useCache:Bool = true, pushToGPU:Bool = true):BitmapData
	{
		...
		if (useCache && cache.enabled && cache.hasBitmapData(id))
		{
			...
			if (isValidBitmapData(bitmapData) && bitmapData.readable /* && (pushToGPU || bitmapData.image.data != null)*/)
			{
				return bitmapData;
			}
		}
		...
		if (image != null)
		{
			...
			#if !macro
			if (pushToGPU && ClientPrefs.cacheOnGPU && Assets.allowGPU) {
				bitmapData.lock();
	...
	**/
	...
	public static inline function getLibrary(name:String):#if lime LimeAssetLibrary #else AssetLibrary #end
	{
		#if lime
	...
	**/
	...
	public static inline function hasLibrary(name:String):Bool
	{
		#if lime
	...
	**/
	public static inline function loadText(id:String):Future<String>
	{
		#if lime
	...
	**/
	public static inline function registerBinding(className:String, library:AssetLibrary):Void
	{
	...
	**/
	public static inline function registerLibrary(name:String, library:AssetLibrary):Void
	{
		#if lime
	...
	public static inline function removeEventListener(type:String, listener:Dynamic, capture:Bool = false):Void
	{
		dispatcher.removeEventListener(type, listener, capture);
	}

	@:noCompletion private static inline function resolveClass(name:String):Class<Dynamic>
	{
	...
	public static inline function unloadLibrary(name:String):Void
	{
		#if lime
